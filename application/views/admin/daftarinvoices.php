                                    ...
                                    <tbody>
                                     <?php foreach ($invoices as $invoices): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $invoices->email;?></td>
                                            <td><?php echo $invoices->date;?></td>
                                            <td><?php echo $invoices->due_date;?></td>
                                            <td><?php echo $invoices->status;?></td>
                                            <td>
                                                <a href="<?php echo site_url('admin/detailinvoices/'.$invoices->id);?>" class="btn btn-default waves-effect waves-light btn-sm m-b-5"><i class="fa fa-search"></i> Detail</a>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>
                                </tbody>
