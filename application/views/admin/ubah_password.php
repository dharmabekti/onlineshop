    ...
    <div class="container">
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-heading"><h3 class="panel-title">Ubah Password</h3></div>
          <div class="panel-body">
            <?php echo form_open_multipart('admin/ubahpassword',['class'=>'form-horizontal','role'=>'form']);?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="password" name="new_password" class="form-control" placeholder="Password Baru" id="txtPassword">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label">Konfirmasi Password</label>
              <div class="col-sm-9">
                <input type="password" name="konfirm_new_password" class="form-control" placeholder="Konfirmasi Password" id="txtConfirmPassword">
              </div>
            </div>
            <div class="form-group m-b-0">
              <div class="col-sm-offset-3 col-sm-9">
                <button type="submit" class="btn btn-info waves-effect waves-light" id="btnSubmitPass">Simpan</button>
              </div>
            </div>
            <?php echo form_close();?>
          </div> <!-- panel-body -->
