						...
						<div class="span4 offset2">
							<div class="well">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input name="invoice_id" class="span3"  type="name" id="inputEmail0" placeholder="" required=""
										oninvalid="this.setCustomValidity('Silahkan Masukkan Kode Invoice')" oninput="setCustomValidity('')" >
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="inputEmail0">Upload Bukti Transfer</label>
									<div class="controls">
										<input type="file" class="form-control" name="userfile" required="" accept='image/*'
										oninvalid="this.setCustomValidity('Silahkan Upload Bukti Pembayaran')" oninput="setCustomValidity('')">
									</div>
								</div>
								<div class="controls">
